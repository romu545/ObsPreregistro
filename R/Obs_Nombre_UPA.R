...
#' @param Lista_Referencia_Nombres Listado de nombres catalogados como validados.
...
Obs_Nombre_UPA <- function(Datos_Evaluar, Lista_Referencia_Nombres, Nom_No_Evaluar) {
  ...
  Observaciones <-
    ...
    dplyr::anti_join(y = Lista_Referencia_Nombres, by = c("Col_Aux_1" = "Nombres")) |>
    dplyr::summarise(
